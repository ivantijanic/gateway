<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="NETframeworkPaymentGateway.Default" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <script data-main="payment-js" src="http://gateway.bankart.si/js/integrated/payment.min.js"></script>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
        <title>Transaction settings - C#:</title>    
    </head>
    <body style="background-color: #63E9FC">
        <P>Transaction settings  - C#:</P>
            ...
            function selectedTransaction() {
                ...
                if (tranType == "debit") {
                    ...
                    for (var i = 0, length = radios.length; i < length; i++) {
                        if (radios[0].checked) {
                            document.getElementById('payment_form').action = 'Debit';
                            break;
                        } else if (radios[1].checked) {
                            document.getElementById('payment_form').action = 'iframe.aspx';
                            break;
                        } else if (radios[2].checked) {
                            document.getElementById('payment_form').action = 'javaScript.aspx';
                            break;
                        } else {
                    ...
                    for (var i = 0, length = radios.length; i < length; i++) {
                        if (radios[0].checked) {
                            document.getElementById('payment_form').action = 'Preauth';
                            break;
                        } else if (radios[1].checked) {
                            document.getElementById('payment_form').action = 'iframe.aspx';
                            break;
                    ...
                    switch (value) {
                        case "":
                            ...
                            return false;
                        default:
                            document.getElementById('payment_form').action = 'Capture';
                            break;
                    }
                    ...
                    switch (value) {
                        case "":
                            ...
                            return false;
                        default:
                            document.getElementById('payment_form').action = 'Void';
                            break;
                    }
                    ...
                    switch (value) {
                        case "":
                            ...
                            return false;
                        default:
                            document.getElementById('payment_form').action = 'Refund';
                            break;
                    }
                    ...
                    switch (value) {
                        case "":
                            ...
                            return false;
                        default:
                            document.getElementById('payment_form').action = 'Status';
                            break;
                    }
                } else {
