<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Refund.aspx.cs" Inherits="NETframeworkPaymentGateway.Refound" %>
...
<body style="background-color: #63E9FC">
    <%
        ...
        transactionType myTransaction = new transactionType
        {
            ...
            ItemElementName = ItemChoiceType1.refund,
            Item = new refundType
            {
                transactionId = "R-" + Guid.NewGuid().ToString(),
